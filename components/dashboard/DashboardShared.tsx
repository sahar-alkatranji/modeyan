...
export const Icon = ({ name, className = "w-3 h-3" }: { name: string, className?: string }) => {
    switch (name) {
        ...
        case 'info': return <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>;
        case 'camera': return <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>;
        default: return null;
    }
};
...
export const StatusPill = ({ status }: { status: string }) => {
  ...
  const styles: Record<string, string> = {
      ...
      quote_submitted: 'bg-cyan-500/20 text-cyan-300 border-cyan-500/30',
      quote_accepted: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30',
